...
function PleaseSeeWiki( repoLink: IRepoLinks ) : JSX.Element { return <p>Please see the { repoLink.wiki }  for more information</p>;  } 

export function CommandsPage( repoLink: IRepoLinks ): JSX.Element {

  const result: JSX.Element = <PivotItem  headerText={ 'Commands' } >
